...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
					<img src="image\common/header.jpg" alt="正品保障" title="正品保障" height="50" width="320">
</div>	</div>
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span18 last">
			...
			<div class="productImage">
					<a title="" style="outline-style: none; text-decoration: none;" id="zoom" href="http://image/common/bigPic1ea8f1c9-8b8e-4262-8ca9-690912434692.jpg" rel="gallery">
