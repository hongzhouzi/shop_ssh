		...
		<div class="span24">
			<div class="step step1">
				...
				<table>
					...
					<tr>
						...
						<tr>
							...
							<td>
								<a href="${ pageContext.request.contextPath }/cart_removeCart?pid=<s:property value="#cartItem.product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
						</s:iterator>
					</tbody>
				...
				<div class="bottom">
					...
					<a href="${ pageContext.request.contextPath }/order_submitOrder" id="submit" class="submit">提交订单</a>
				</div>
